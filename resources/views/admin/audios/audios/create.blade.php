...
@section('content')
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('admin.audios.audios.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row titleInput">
                        ...
                        <div class="col-6 mb-3">
                            <label for="audio_name" class="form-label">{{ trans('dashboard.audios.brief_description') }}</label>
                        ...
                        <div class="col-6 mb-3">
                            <label for="youtube_link" class="form-label">{{ trans('dashboard.audios.youtube_link') }}</label>
