...
@section('content')
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('admin.videos.videos.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row titleInput">
                        ...
                        <div class="col-6 mb-3">
                            <label for="video_name" class="form-label">{{ trans('dashboard.videos.brief_description') }}</label>
