        ...
        <div class="table-responsive p-2">
            <table class="myDatatable table table-bordered">
                ...
                <tr>
                    ...
                    <th>{{trans('dashboard.courses.subscriptions-count')}}</th>
                    ...
                    <tr>
                        ...
                        <td>
                            @if (!empty($course->image))
                                <img src="{{ asset($course->image) }}" style="width:75px;height:75px;"  alt=""/>
                            @else
                                <img src="{{ asset('assets/admin/images/courses.webp') }}" style="width:75px;height:75px;"  alt=""/>
                            @endif
