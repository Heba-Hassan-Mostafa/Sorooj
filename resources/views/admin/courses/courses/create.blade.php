...
@section('content')
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('admin.courses.courses.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                            ...
                            <ul id="treeview1" class="list-unstyled">
                                ...
                                @foreach ($categories as $category)
                                    <ul class="col-3 parentCategory">
                                        ...
                                        @include('admin.courses.courses.subCategoryList', [
