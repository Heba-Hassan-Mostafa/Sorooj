...
@endsection
@section('title')
    {{ trans('dashboard.blogs.edit-blog-category') }}
@endsection
@section('content')
    <h4 class="py-3 mb-4">
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('admin.blogs.category.update', $category->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="row">
                            ...
                            <ul id="treeview1">
                                ...
                                @foreach ($parentCategories  as $parentCategory)
                                    <ul class="col-4 parentCategory">
                                        ...
                                        @include('admin.blogs.categories.subCategoryListEdit', [
