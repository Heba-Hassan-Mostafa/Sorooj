...
class Blog extends Model implements HasMedia
{
    ...
    protected $fillable = ['blog_name', 'slug', 'blog_content', 'brief_description', 'author_name', 'category_id', 'publish_date',
   ...
   // protected $definedRelations = ['category', 'videos', 'media', 'favorites'];
    ...
    protected function image(): Attribute
    {
        return Attribute::make(
            get: fn($value) => ($this->getFirstMediaUrl('image') != ''
                ? $this->getFirstMediaUrl('image') : asset('assets/admin/images/blogs.webp')),
        );
    }
    ...
    #Scopes
    public function scopeOfBlog_name($query, $keyword)
    {
        return $query->where('blog_name', 'like', '%' . $keyword . '%');
    }
